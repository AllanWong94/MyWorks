...
//        System.out.println("Current Depth: "+ts.getTcDepth());
...
//        System.out.println("start_lon: "+startLon);
//        System.out.println("start_lat: "+startLat);
//        System.out.println("end_lon: "+endLon);
//        System.out.println("end_lat: "+endLat);
        Route r=new Route(g,startLon,startLat,endLon,endLat);
        return r.getRoute();
    }
    ...
    public static List<String> getLocationsByPrefix(String prefix) {
        return g.getNamesByPrefix(prefix);
    }
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        return g.getLocations(locationName);
    }
}
